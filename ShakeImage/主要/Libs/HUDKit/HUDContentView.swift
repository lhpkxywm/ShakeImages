    ...
    override func layoutSubviews() {
        ...
        case .notification:
            ...
            if let detail = detailTextLabel.text as NSString? {
                ...
                detailTextLabel.frame.size.height = detail.boundingRect(with: CGSize(width: detailTextLabel.frame.width, height: CGFloat.greatestFiniteMagnitude), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font : detailTextLabel.font ?? 14], context: nil).size.height
            }
...
extension HUDContentView{
    ...
    var visableKeyboardFrame: CGRect? {
        ...
        for possibleKeyboard in keyboardWindow.subviews {
            ...
            if possibleKeyboard.isKind(of: NSClassFromString("UIKeyboard")!){
